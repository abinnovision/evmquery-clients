...
n8n community node for [evmquery](https://evmquery.com): query EVM smart contracts using CEL expressions, both in regular n8n workflows and as an AI Agent tool.
